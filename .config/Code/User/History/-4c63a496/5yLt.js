...
function addToTable(play1,play2) {
    ...
    player1Cell.textContent = playerOne; // Add 'cate' to the cell
    newRow.appendChild(play1); // Append the cell to the row

    // Create the second cell for Player 2
    const player2Cell = document.createElement('td');
    player2Cell.textContent = playerTwo; // Add 'simon' to the cell
    newRow.appendChild(play2); // Append the cell to the row
