...
// // Function to insert a bulleted list at the cursor position in the text area
...
//     // Insert the new list item at the cursor position
//     textArea.value = text.slice(0, startPos) + newItem + text.slice(endPos);

//     // Move the cursor position after the inserted list item
//     textArea.setSelectionRange(startPos + 2, startPos + 11);
// }
