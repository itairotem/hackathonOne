...
function insertBulletedList() {
    ...
    // Insert the bulleted list at the cursor position
    textArea.value = text.slice(0, startPos) + bulletList + text.slice(endPos);

    // Move the cursor position after the bulleted list
    textArea.setSelectionRange(startPos + 2, startPos + 9);
}
